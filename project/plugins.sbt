...
resolvers += "TNM-Snapshots" at "http://nexus.thenewmotion.com/content/repositories/snapshots-public"
...
addSbtPlugin("com.thenewmotion" % "sbt-soapui-mockservice" % "0.1.4-SNAPSHOT")